...
export const BranchManagerPdfGenerator = async (req, res) => {
  try {
    ...
    function checkPageBreak(rowHeight, tableY) {
      return tableY + rowHeight > MAX_PAGE_HEIGHT;
    }
    ...
    doc.fontSize(32).text("BRANCH", doc.page.margins.left, doc.y + 20, {
      align: "left",
    });
    doc.fillColor("#673ab7");
    doc.fontSize(32).text("ORDER", doc.page.margins.left + 133, doc.y - 44, {
      align: "left",
    });
    doc.fillColor("#2196f3");
    doc.fontSize(32).text("REPORT", doc.page.margins.left + 242, doc.y - 44, {
      align: "left",
    });
